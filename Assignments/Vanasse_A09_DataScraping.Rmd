...
#2
waterURL <- read_html("https://www.ncwater.org/WUDC/app/LWSP/report.php?pwsid=03-32-010&year=2020")
...
```{r scrape.the.data}
#3
water.system.name <- waterURL %>% html_nodes('div+ table tr:nth-child(1) td:nth-child(2)') %>% html_text()
pwsid <- waterURL %>% html_nodes('td tr:nth-child(1) td:nth-child(5)') %>% html_text()
ownership <- waterURL %>% html_nodes('div+ table tr:nth-child(2) td:nth-child(4)') %>% html_text()
