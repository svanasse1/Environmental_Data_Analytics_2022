...
library(lubridate)
EPAair.O3.2018.data <- read.csv("../Data/Raw/EPAair_O3_NC2018_raw.csv", stringsAsFactors = TRUE)
EPAair.O3.2019.data <- read.csv("../Data/Raw/EPAair_O3_NC2019_raw.csv", stringsAsFactors = TRUE)
EPAair.PM25.2018.data <- read.csv("../Data/Raw/EPAair_PM25_NC2018_raw.csv", stringsAsFactors = TRUE)
EPAair.PM25.2019.data <- read.csv("../Data/Raw/EPAair_PM25_NC2019_raw.csv", stringsAsFactors = TRUE)
...
```{r}
#7
EPAair.O3.2018.processed <- read.csv("../Data/Processed/EPAair_O3_NC2018_processed.csv", stringsAsFactors = TRUE)
EPAair.O3.2019.processed <- read.csv("../Data/Processed/EPAair_O3_NC2019_processed.csv", stringsAsFactors = TRUE)
EPAair.PM25.2018.processed <- read.csv("../Data/Processed/EPAair_PM25_NC2018_processed.csv", stringsAsFactors = TRUE)
EPAair.PM25.2019.processed <- read.csv("../Data/Processed/EPAair_PM25_NC2019_processed.csv", stringsAsFactors = TRUE)

EPAair.O3.PM25.18thru19 <- rbind(EPAair.O3.2018.processed, EPAair.O3.2019.processed, EPAair.PM25.2018.processed, EPAair.PM25.2019.processed)
...
#9
EPAair.O3.PM25.18thru19.processed.spread <- pivot_wider(EPAair.O3.PM25.18thru19.processed, names_from = AQS_PARAMETER_DESC, values_from = meanAQI)

#10
dim(EPAair.O3.PM25.18thru19.processed.spread)

#11
write.csv(EPAair.O3.PM25.18thru19.processed.spread, row.names = FALSE, file = "../Data/Processed/EPAair_O3_PM25_NC2122_Processed.csv")
```
...
```{r}
#12(a,b)
EPAair.O3.PM25.NC2122.Processed <- read.csv("../Data/Processed/EPAair_O3_PM25_NC2122_Processed.csv", stringsAsFactors = TRUE)
