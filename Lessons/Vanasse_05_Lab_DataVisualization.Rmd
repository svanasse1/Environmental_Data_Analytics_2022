...
PeterPaulPlot.Ex2 <- 
  ggplot(subset(PeterPaul.chem.nutrients, depth == 0), aes(x=sampledate, y=temperature_c)) +
  geom_point(aes(color=depth), size =0.5) +
  ylab("Temperature in Celsius") +
  scale_color_viridis(option = "magma", direction = -1) + 
  scale_x_date(date_break = "5 years", date_labels = "%Y")
...
PeterPaulPlot.Ex3 <- 
  ...
  ylab(expression("O"[3]* " AQI Valuue"))
print(PeterPaulplot.Ex3)
